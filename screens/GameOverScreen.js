  ...
  return (
    <View style={styles.screen}>
      ...
      <Card style={styles.results}>
        ...
        <Text style={styles.playerText}>Player's</Text> number of tries: <Text style={styles.playerText}>{props.results.playerNumberOfTries}</Text>
        </Text>
        <Text style={styles.resultText}>
        <Text style={styles.computerText}>Computer's</Text> number of tries: <Text style={styles.computerText}>{props.results.computerNumberOfTries}</Text>
        </Text>
      </Card>
      <View style={styles.restart}>
        <MainButton title="Play again" onPress={props.onRestart} />
      </View>
    </View>
  );
}
